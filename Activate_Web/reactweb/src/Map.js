...
class MapAPI extends Component {
  render() {
    ...
    const display = apiData && apiData.map((item) => <Marker key={item["timestamp"]} width='60px'icon={{ url: require("./bonobono.png").default, scaledSize: new window.google.maps.Size(30, 30) }} position={{lat : parseFloat(item['latitude']), lng: parseFloat(item['longitude'])}}/>);
